...
cd .\packages\atom-material-ui&&npm run winbuild&&cd ..&&cd atom-material-syntax-dark&&npm run build&&cd ..&&cd ..&&cd .\dot-atom\packages&&cd atom-ng-browser&&npm run build&&cd ..&&cd color-picker&&npm run build&&cd ..&&cd minimap&&npm run build&&cd ..&&cd ..&&cd ..
