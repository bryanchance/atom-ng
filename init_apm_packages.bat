...
cd .\packages\atom-material-ui&&npm run clean&&npm run build&&cd ..&&cd atom-material-syntax-dark&&npm run clean&&npm run build&&cd ..&&cd ..&&cd .\dot-atom\packages&&cd atom-ng-browser&&npm run clean&&npm run build&&cd ..&&cd color-picker&&npm run clean&&npm run build&&cd ..&&cd minimap&&rmdir /s node_modules&&npm install&&npm run build&&cd ..&&cd ..&&cd ..
