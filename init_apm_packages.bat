...
cd ./dot-atom/packages&&cd atom-ng-browser&&npm run clean&&npm run build&&cd ..&&cd color-picker&&npm run clean&&npm run build&&cd ..&&cd minimap&&npm run clean&&npm install&&npm run build&&cd ..&&cd ..&&cd ..
