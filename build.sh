...
installDeps () {
	sudo apt-get install build-essential fakeroot git libsecret-1-dev libx11-dev libxkbfile-dev node-gyp node-istanbul nodejs npm python2 python2.7-dev rpm
}
case $1 in
