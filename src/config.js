...
// ```
//
// See [package docs](https://flight-manual-atom-io.github.io/hacking-atom/sections/package-word-count/) for
// more info.
//
// ## Config Schemas
//
...
class Config {
  ...
  */
  ...
  //     See [the scopes docs](https://flight-manual-atom-io.github.io/behind-atom/sections/scoped-settings-scopes-and-scope-descriptors/)
  ...
  observe(...args) {
    ...
    if (args.length === 2) {
      ...
      console.error(
        'An unsupported form of Config::observe is being used. See https://flight-manual-atom-io.github.io/api/latest for details'
      );
      return;
    }
