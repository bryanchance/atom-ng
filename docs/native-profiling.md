# Profiling the Atom-ng Render Process on macOS with Instruments

![Instruments](https://cloud.githubusercontent.com/assets/1789/14193295/d503db7a-f760-11e5-88bf-fe417c0cd913.png)

* Determine the version of Electron for your version of Atom-ng.
...
* Now create a time profile in Instruments.
  ...
  * In Atom-ng, determine the pid to attach to by evaluating `process.pid` in the dev tools console.
